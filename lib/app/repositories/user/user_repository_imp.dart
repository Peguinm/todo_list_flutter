...
class UserRepositoryImp implements UserRepository {
  ...
  UserRepositoryImp({required FirebaseAuth firebaseAuth}) : _firebaseAuth = firebaseAuth;
    ...
    try {
      ...
      if (e.code == 'email-already-in-use') {
        ...
        if (loginTypes.contains('password')) {
          throw AuthExceptions(message: 'O e-mail já está em uso, por favor utilize outro');
        } else {
          throw AuthExceptions(message: 'Você já possuí um login com o Google, utilize-o para acessar');
        }
      } else {
        throw AuthExceptions(message: e.message ?? 'Houve um erro ao se registrar');
      }
    }
  }
